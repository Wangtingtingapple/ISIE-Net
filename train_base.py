...
from models.isienet import get_isie
...
def parse_args():
    ...
    parser.add_argument("--run_name", type=str, default="ISIE-Net", help="run name")
    ...
    ## dataset
    parser.add_argument("--paths_file", type=str, default="/root/autodl-tmp/ISIE-Net-main/Casiav2/mydata.txt",
...
Pixel_scale_Loss_filename = './pixel_scale_Loss.txt'
Edge_Loss_list_filename = './edge_loss.txt'
Image_scale_Loss_list_filename = './image_scale_loss.txt'
redge_scale_Loss_list_filename = './redge_scale_loss.txt'
