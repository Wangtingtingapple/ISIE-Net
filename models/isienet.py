...
def get_isie(backbone='resnet50', pretrained_base=True, nclass=1, sobel=True, n_input=3, constrain=False, **kwargs):
    model = ISIENet(nclass, backbone=backbone,
...
if __name__ == '__main__':
    ...
    model = get_isie(sobel=True, n_input=3,pretrained_base=True, constrain=True)
